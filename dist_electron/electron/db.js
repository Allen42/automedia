...
export function saveProject(projectData) {
    ...
    try {
        const { id, name, novelContent, scriptContent, storyboardsText, storyboards, rhythmPlan, } = projectData;
        const stmt = db.prepare(`
      INSERT OR REPLACE INTO projects (
        id, name, novelContent, scriptContent, storyboardsText, storyboards, rhythmPlan, updatedAt
      ) VALUES (?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)
    `);
        stmt.run(id, name, novelContent || null, scriptContent || null, storyboardsText || null, JSON.stringify(storyboards || []), rhythmPlan || null);
